              ...
              SizedBox(
                ...
                child: PageView(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            25.height,
                            assetType=="financial_assets" ?SizedBox(
                              child: DropdownButtonFormField(
                                icon: const Icon(
                                  Icons.arrow_drop_down_rounded,
                                  color: NBPrimaryColor,
                      ...
                      assetType=="financial_assets" && assetCategory=="cash"? Padding(
                        padding: const EdgeInsets.all(8.0),
                      ...
                      assetType=="financial_assets" && assetCategory=="crypto"? Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                      ...
                      assetType=="financial_assets" && assetCategory=="pension"? Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                      ...
                      assetType=="financial_assets" && assetCategory=="insurance"? Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
