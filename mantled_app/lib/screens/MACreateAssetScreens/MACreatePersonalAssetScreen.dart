...
class MACreatePersonalAssetScreen extends StatefulWidget {
  static String tag = '/MACreatePersonalAssetScreen';

  final String assetType;
  const MACreatePersonalAssetScreen({Key? key, required this.assetType}) : super(key: key);

  @override
  MACreatePersonalAssetScreenState createState() => MACreatePersonalAssetScreenState();
}

class MACreatePersonalAssetScreenState extends State<MACreatePersonalAssetScreen> {
            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    MABeneficiaryScreen(assetID: assetID, assetType: "PersonalEffects",).launch(context);
                  },
                  child: Container(
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Personal", style: primaryTextStyle(weight: FontWeight.w500),),
                      const SizedBox(width: 10,),
                      Image.asset("assets/png/personal.png"),
                    ],
                  ),
                ],
              ),
  ...
  initializeCreateAsset() async {
    ...
    if (_paths2!=null){
      await apiCall.createPersonalAsset(assetData)
          .then((value) {
