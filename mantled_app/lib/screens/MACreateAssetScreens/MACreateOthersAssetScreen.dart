...
class MACreateOthersAssetScreen extends StatefulWidget {
  static String tag = '/MACreateOthersAssetScreen';

  final String assetType;
  const MACreateOthersAssetScreen({Key? key, required this.assetType}) : super(key: key);

  @override
  MACreateOthersAssetScreenState createState() => MACreateOthersAssetScreenState();
}

class MACreateOthersAssetScreenState extends State<MACreateOthersAssetScreen> {
            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    MABeneficiaryScreen(assetID: assetID, assetType: "Memoirs",).launch(context);
                  },
                  child: Container(
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Memoirs", style: primaryTextStyle(weight: FontWeight.w500),),
  ...
  initializeCreateAsset() async {
    ...
    if (_paths2!=null){
      await apiCall.createOthersAsset(assetData)
          .then((value) {
