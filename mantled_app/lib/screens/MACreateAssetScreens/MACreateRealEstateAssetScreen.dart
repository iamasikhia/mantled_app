...
class MACreateRealEstateAssetScreen extends StatefulWidget {
  static String tag = '/MACreateRealEstateAssetScreen';

  final String assetType;
  const MACreateRealEstateAssetScreen({Key? key, required this.assetType}) : super(key: key);

  @override
  MACreateRealEstateAssetScreenState createState() => MACreateRealEstateAssetScreenState();
}

class MACreateRealEstateAssetScreenState extends State<MACreateRealEstateAssetScreen> {
  ...
  String docValue="Select Document Type";
  String propValue="Select Property Type";
            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                     MABeneficiaryScreen(assetID: assetID, assetType:"HousingProperties").launch(context);
                  },
                  child: Container(
  ...
  initializeCreateAsset() async {
    ...
    assetData.assetType = propValue;
    assetData.stateName = stateValue;
    assetData.localGov = lgaValue;
