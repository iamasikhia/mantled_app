...
class MATangibleAssetDetailsSheet extends StatefulWidget {
  final HousePropertyList? mData;
  const MATangibleAssetDetailsSheet( {Key? key,  this.mData}) : super(key: key);

  @override
  MATangibleAssetDetailsSheetState createState() => MATangibleAssetDetailsSheetState();
}

class MATangibleAssetDetailsSheetState extends State<MATangibleAssetDetailsSheet>
