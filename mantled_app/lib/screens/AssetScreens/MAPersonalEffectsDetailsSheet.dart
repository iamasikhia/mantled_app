...
class MAPersonalEffectsDetailsSheet extends StatefulWidget {
  final HousePropertyList? mData;
  const MAPersonalEffectsDetailsSheet( {Key? key,  this.mData}) : super(key: key);

  @override
  MAPersonalEffectsDetailsSheetState createState() => MAPersonalEffectsDetailsSheetState();
}

class MAPersonalEffectsDetailsSheetState extends State<MAPersonalEffectsDetailsSheet>
