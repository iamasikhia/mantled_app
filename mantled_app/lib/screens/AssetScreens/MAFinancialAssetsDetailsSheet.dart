...
class MAFinancialAssetsDetailsSheet extends StatefulWidget {
  final HousePropertyList? mData;
  const MAFinancialAssetsDetailsSheet( {Key? key,  this.mData}) : super(key: key);

  @override
  MAFinancialAssetsDetailsSheetState createState() => MAFinancialAssetsDetailsSheetState();
}

class MAFinancialAssetsDetailsSheetState extends State<MAFinancialAssetsDetailsSheet>
