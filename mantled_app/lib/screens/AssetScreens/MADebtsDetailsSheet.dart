...
class MADebtsDetailsSheet extends StatefulWidget {
  final HousePropertyList? mData;
  const MADebtsDetailsSheet( {Key? key,  this.mData}) : super(key: key);

  @override
  MADebtsDetailsSheetState createState() => MADebtsDetailsSheetState();
}

class MADebtsDetailsSheetState extends State<MADebtsDetailsSheet>
