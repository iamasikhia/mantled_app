...
class MARealEstateDetailsSheet extends StatefulWidget {
  final HousePropertyList? mData;
  const MARealEstateDetailsSheet( {Key? key,  this.mData}) : super(key: key);

  @override
  MARealEstateDetailsSheetState createState() => MARealEstateDetailsSheetState();
}

class MARealEstateDetailsSheetState extends State<MARealEstateDetailsSheet>
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text("My new Document",
                              style: primaryTextStyle(size: 19) ,textAlign: TextAlign.right,),
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text("20a Beckley Avenue, Millenium Estate",
                              style: primaryTextStyle(size: 20, ), textAlign: TextAlign.right,),
                          ),
                        ],
                      ),
                      15.height,
