...
class MALawyerInfoScreen extends StatefulWidget {
  const MALawyerInfoScreen({Key? key}) : super(key: key);

  @override
  MALawyerInfoScreenState createState() => MALawyerInfoScreenState();
}

class MALawyerInfoScreenState extends State<MALawyerInfoScreen> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child:  Padding(
                  ...
                  child: Text(getInitials(lawyerName),
