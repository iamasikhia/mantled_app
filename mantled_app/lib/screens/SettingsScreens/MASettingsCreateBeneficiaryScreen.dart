...
class MASettingsCreateBeneficiaryScreen extends StatefulWidget {
  static String tag = '/MASettingsCreateBeneficiaryScreen';



  const MASettingsCreateBeneficiaryScreen({Key? key,}) : super(key: key);

  @override
  MASettingsCreateBeneficiaryScreenState createState() => MASettingsCreateBeneficiaryScreenState();
}

class MASettingsCreateBeneficiaryScreenState extends State<MASettingsCreateBeneficiaryScreen> {
  ...
  initializeCreateBeneficiary() {
    ...
    apiCall.createSettingsBeneficiary(
      addBeneficiary
    ).then((value) {
      loader.Loader.hide();
      _show(context);
