...
class MAChangePinScreen extends StatefulWidget {
  const MAChangePinScreen({Key? key}) : super(key: key);

  @override
  _MAChangePinScreenState createState() => _MAChangePinScreenState();
}

class _MAChangePinScreenState extends State<MAChangePinScreen> {
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                nbAppTextFieldWidget(oldPassCont, 'Old Pin', TextFieldType.PASSWORD, focus: oldPassFocus, nextFocus: newPassFocus),
                20.height,
                nbAppTextFieldWidget(newPassCont, 'New Pin', TextFieldType.PASSWORD, focus: newPassFocus, nextFocus: confirmPassFocus),
                20.height,
                nbAppTextFieldWidget(confirmPassCont, 'Re-enter New Pin', TextFieldType.PASSWORD, focus: confirmPassFocus),
